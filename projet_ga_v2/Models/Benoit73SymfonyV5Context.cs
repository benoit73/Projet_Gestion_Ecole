...
public partial class Benoit73SymfonyV5Context : DbContext
{
    ...
    {
     string serverAdress = Properties.Settings.Default.ServerAdress;
    ...
    optionsBuilder.UseMySql($"server={serverAdress};port={port};database={database};uid={uid};pwd={pwd}", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.6.16-mariadb"));
    }
